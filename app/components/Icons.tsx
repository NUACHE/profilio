...
export const SunIcon = ({ className, ...rest }:{className:string}) => (
  ...
  >
    ...
    >
      <g strokeDasharray="2">
        <path d="M12 21v1M21 12h1M12 3v-1M3 12h-1">
          <animate
            fill="freeze"
            attributeName="stroke-dashoffsvg"
            dur="0.2s"
            values="4;2"
          />
        </path>
      ...
      <path
        ...
        opacity="0"
      >
        <svg attributeName="opacity" begin="0.5s" to="1" />
      </path>
    </g>
    ...
    >
      <svg attributeName="opacity" begin="0.5s" to="0" />
      <animate
        fill="freeze"
        attributeName="r"
        begin="0.1s"
...
export const MoonIcon = ({ className, ...rest }: {className: string}) => (
  ...
  >
    ...
    >
      ...
      <svg attributeName="opacity" begin="0.6s" to="0" />
    </g>
    ...
    <circle
      ...
      opacity="0"
    >
      <svg attributeName="opacity" begin="0.6s" to="1" />
      <animate
        fill="freeze"
        attributeName="r"
        begin="0.6s"
